...
HELPMSG="$(basename ${0}) -l LASTNAME | -n KNOWNAS [--simple-display|--pretty-display|--csv-display|--id-only|--check-exist-only]
Find composer by last name or full known-as name."
